    ...
    virtual QCString trCompoundListDescription()
    {
      ...
      else
      {
        return "Here are the classes, structs, "
               "unions interfaces and annotations with brief descriptions:";
      }
    }
...
//////////////////////////////////////////////////////////////////////////
                                    ...
                                    bool isTemplate)
    {
      ...
      switch(compType)
      {
        ...
        case ClassDef::Annotation: result+=" Annotation"; break; // Xtend annotation
...
//////////////////////////////////////////////////////////////////////////
    ...
    { // single is true implies a single file
      ...
      switch(compType)
      {
        ...
        case ClassDef::Union:      result+="union"; break;
        case ClassDef::Interface:  result+="interface"; break;
        case ClassDef::Annotation: result+="annotation"; break;
        case ClassDef::Protocol:   result+="protocol"; break;
        case ClassDef::Category:   result+="category"; break;
        case ClassDef::Exception:  result+="exception"; break;
        default: break;
