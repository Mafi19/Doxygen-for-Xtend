...
QCString tempArgListToString(const ArgumentList &al,SrcLangExt lang,bool includeDefault)
{
  ...
  for (const auto &a : al)
  {
    if (a.defval.isEmpty() || includeDefault)
    {
      ...
      if (!a.typeConstraint.isEmpty() && (lang==SrcLangExt_Java || lang==SrcLangExt_Xtend))
      {
...
void initDefaultExtensionMapping()
{
  ...
  updateLanguageMapping(".xtend",    "xtend");
}
...
QCString langToString(SrcLangExt lang)
{
  switch(lang)
  {
    ...
    case SrcLangExt_Xtend:    return "Xtend";
  }
  return "Unknown";
}
...
{
  if (lang==SrcLangExt_Java || lang==SrcLangExt_Xtend || lang==SrcLangExt_CSharp || lang==SrcLangExt_VHDL || lang==SrcLangExt_Python)
  {
    return ".";
  }
